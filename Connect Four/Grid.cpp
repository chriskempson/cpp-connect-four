...
/**
 * The grid is comprised of a single repeated graphic. The player pieces are 
 * contained within a sprite that has an image for a blank cell, a cell with
 * a red piece and a cell with a yellow piece.
 */
void Grid::render()
{
